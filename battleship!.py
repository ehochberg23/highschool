...
def winGame(board1, board2):
    ...
    if (board1[0][0] != "X") and (board1[0][1] != "X") and (board1[0][2] != "X")and (board1[0][3] != "X") and (board1[0][4] != "X") and (board1[1][0] != "X") and (board1[1][1] != "X") and (board1[1][2] != "X") and (board1[1][3] != "X") and (board1[1][4] != "X") and (board1[2][0] != "X") and (board1[2][1] != "X") and (board1[2][2] != "X") and (board1[2][3] != "X") and (board1[2][4] != "X") and (board1[3][0] != "X") and (board1[3][1] != "X")and (board1[3][2] != "X") and (board1[3][3] != "X") and (board1[3][4] != "X") and (board1[4][0] != "X") and (board1[4][1] != "X") and (board1[4][2] != "X")and (board1[4][3] != "X") and (board1[4][4] != "X"):
        print("Computer wins")       #if all the X's are hit on the player's board
        return 1

    elif (board2[0][0] != "X") and (board2[0][1] != "X") and (board2[0][2] != "X") and (board2[0][3] != "X") and (board2[0][4] != "X") and (board2[1][0] != "X") and (board2[1][1] != "X") and (board2[1][2] != "X") and (board2[1][3] != "X") and (board2[1][4] != "X") and (board2[2][0] != "X") and (board2[2][1] != "X") and (board2[2][2] != "X") and (board2[2][3] != "X") and (board2[2][4] != "X") and (board2[3][0] != "X") and (board2[3][1] != "X")and (board2[3][2] != "X") and (board2[3][3] != "X") and (board2[3][4] != "X") and (board2[4][0] != "X") and (board2[4][1] != "X") and (board2[4][2] != "X")and (board2[4][3] != "X") and (board2[4][4] != "X"):
